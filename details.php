...
echo '<td><h3>' . $row['product_name'] . '</h3></td>' . "\n";
	...
	echo '<form id="addCartForm" method="POST" class="form-inline">'; 
	echo '<label>Qty</label>';
	echo '<br/>';
	echo '<select style="width:60px" class="form-control" name="quantity">';
	...
	echo '<br/>';
	echo '<select style="width:60px" class="form-control" name="size">';
