...
sub settings(){
	...
	<h1 class="contactform cf_header" id="cf_titleheader">$Contact Lacys</h1>
	$content
    </div>
	...
	# spread the word.
	$settings->{'show_contact_form_link'} = 0;
